...
/*Cuando el proceso padre finaliza antes que el proceso hijo, el proceso hijo se convierte en un proceso huérfano.
Estos procesos huérfanos son "recogidos" por el proceso init o (demonio systemd)*/
