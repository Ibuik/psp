...
/*Cuando los procesos hijos finalizan, pero el padre NO termina se convierten en estados zombies.
En ocasiones el programa padre si ha terminado pero el sistema no libera el PCB del proceso padre,
por lo que el sistema clasifica al proceso/s hijo/s como zombie/s*/
